...
pub unsafe fn i64_to_f128(mut a: int64_t) -> float128_t {
    ...
    if a == 0 {
        ...
        shiftDist = (softfloat_countLeadingZeros64(absA) as i32
            + 49 as i32) as int_fast8_t;
        if 64 as i32 <= shiftDist as i32 {
            zSig.v64 = absA << shiftDist as i32 - 64 as i32;
