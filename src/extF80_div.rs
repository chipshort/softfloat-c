...
pub unsafe fn extF80_div(
    ...
    if expA == 0x7fff as i32 as i64 {
        if sigA & 0x7fffffffffffffff as u64 != 0 {
            current_block = 8806525362459891717;
        } else if expB == 0x7fff as i32 as i64 {
            if sigB & 0x7fffffffffffffff as u64 != 0 {
                current_block = 8806525362459891717;
            } else {
                current_block = 9040374712263943206;
            }
        } else {
            current_block = 16374181240773317894;
        }
    } else {
        if expB == 0x7fff as i32 as i64 {
            if sigB & 0x7fffffffffffffff as u64 != 0 {
                ...
                current_block = 11232613145041356269;
            }
        } else {
            if expB == 0 {
            ...
            match current_block {
                ...
                _ => {
                    ...
                    match current_block {
                        11232613145041356269 => {}
                        _ => {
                            expZ = expA - expB + 0x3fff as i32 as i64;
                            if sigA < sigB {
                                expZ -= 1;
                            ...
                            loop {
                                ...
                                sigZ = (sigZ << 29 as i32).wrapping_add(q);
                            }
                            if (q.wrapping_add(1 as i32 as u64)
                                & 0x3fffff as i32 as u64)
                                < 2 as i32 as u64
                            {
                                rem = softfloat_shortShiftLeft128(
                                    rem.v64,
                            ...
                            sigZ = (sigZ << 6 as i32)
                                .wrapping_add(q >> 23 as i32);
                            sigZExtra = q << 41 as i32;
        ...
        match current_block {
            ...
            _ => {
                ...
                current_block = 10578954035207903246;
            }
        }
    }
    match current_block {
